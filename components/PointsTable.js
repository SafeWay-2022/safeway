...
export default function PageTable() {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'geo',
      render: (coordinates) => {
        return <GeoLocation readonly={true} withoutInput={true} value={coordinates} />;
      },
    },
    {
      title: 'Country',
      ...
      <main>
          ...
          {route === '/poi/' && (
            <>
              ...
              <Button
                ...
                size="large"
                icon={<SearchOutlined />}
                style={{ background: '#4742DD', display: 'flex', alignItems: 'center' }}
              >
                Search
              </Button>
            </>
        ...
        {!mapView ? (
          ...
          <div style={{ height: '900px' }}>
            <MapPicker value={value} list={list} setLimit={setLimit} refetch={refetch} />
          </div>
        )}
      </main>
    </div>
