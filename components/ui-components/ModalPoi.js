...
const ModalComponent = ({ record, refetch, title, doFetch, isTable }) => {
    ...
    return (
        <>
            ...
            <Modal width={1500} title={title} visible={isModalVisible} footer={null} onCancel={() => setIsModalVisible(false)}>
                <Form
                    {...layout}
                    onFinish={onFinish}
                    name="nest-messages"
                ...
                >
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-around', flexWrap: 'wrap' }}>
                            <Form.Item label="CONTACT PERSON" labelCol={{ span: 24 }}>
                                <InputText placeholder="Enter contact person" style={{ width: '200px' }} value={state.contact_person} onChange={e => setState(p => ({ ...p, contact_person: e.target.value }))} />
                            </Form.Item>
                            ...
                            <Form.Item label="OPEN HOURS" labelCol={{ span: 24 }}>
                                <InputText placeholder="Enter time" value={state.open_hours} onChange={e => setState(p => ({ ...p, open_hours: e.target.value }))} />
                            </Form.Item>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                        ...
                        <Form.Item label="WHATSAPP" labelCol={{ span: 24 }}>
                            <InputText placeholder="Enter whatsapp" style={{ width: '200px' }} value={state.whatsapp} onChange={e => setState(p => ({ ...p, whatsapp: e.target.value }))} />
                        </Form.Item>
                    </div>
